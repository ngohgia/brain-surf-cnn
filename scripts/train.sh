...
python -u train_with_mse.py \
       ...
       --save_dir /share/sablab/nfs03/users/ghn8/TaskContrastsFromRest/debug/ch50_scheduled_feat64_s8_c50_lr0.01_seed28/finetuned \
       --n_val_subj 50 \
       --n_channels_per_hemi 48
