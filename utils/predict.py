...
from parser import test_args
from dataset import MultipleSampleMeshDataset
from utilities import CONTRASTS, save_checkpoint
        ...
        for i in range(len(subj_ids)):
            ...
            if not os.path.exists(pred_file):
                ...
                for sample_id in range(args.n_samples_per_subj):
                    ...
                    # subj_rsfc_data = torch.cuda.FloatTensor(np.expand_dims(np.load(rsfc_file).T, axis=0))
