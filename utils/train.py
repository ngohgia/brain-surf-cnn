...
from parser import train_args
from dataset import MultipleSampleMeshDataset
from utilities import CONTRASTS, save_checkpoint, contrast_mse_loss
...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        train_loss, train_corr = experiment.train(model, train_loader, optimizer, loss_fn, args.loss, within_subj_margin, across_subj_margin)
        val_loss, val_corr     = experiment.eval(model, val_loader, loss_fn, args.loss, within_subj_margin, across_subj_margin)
