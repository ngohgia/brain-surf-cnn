...
# HCP_SUBJ_IDS=${PWD}/sample_HCP_train_val_subj_ids.csv # Replace by ../../data/MICCAI2020/HCP_train_val_subj_ids.csv to replace MICCAI2020 results
# test-retest subjects
HCP_SUBJ_IDS=${PWD}/sample_HCP_test_retest_subj_ids.csv # Replace by ../../data/MICCAI2020/HCP_test_retest_subj_ids.csv to replace MICCAI2020 results

HCP_NODE_TS_DIR=$HCP_DATA_DIR/HCP_PTN1200/node_timeseries/3T_HCP1200_MSMAll_d50_ts2

DATA_OUTPUT_DIR=/home/ghn8/brain_surf_cnn/experiments/MICCAI2020/sample_data
GIFTI_DIR=$DATA_OUTPUT_DIR/gifti

NUM_ICS=50
NUM_SAMPLES=8

PREPROCESS_DIR=/home/ghn8/brain_surf_cnn/preprocess
